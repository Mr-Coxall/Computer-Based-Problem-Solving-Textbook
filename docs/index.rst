...
A PDF version of this textbook can be downloaded `here <https://computer-based-problem-solving-textbook.readthedocs.io/_/downloads/en/latest/pdf/>`_, for offline reading.
